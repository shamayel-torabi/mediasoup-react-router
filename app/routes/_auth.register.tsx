                ...
                <Card className="min-h-96">
                    <Form method="post">
                        <CardHeader className="mb-5">
                            <CardTitle>ثبت نام کاربر</CardTitle>
                        </CardHeader>
                        <CardContent>
                            ...
                            <div className="mb-5 grid grid-cols-2 gap-1">
                                ...
                                <div>
                                    <Label htmlFor="confirmPassword" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">تائید گذرواژه</Label>
                                    <Input
                                        dir="ltr"
                                        type="password"
                                        id="confirmPassword"
